...
#################################################
#expression data
expr.data <- read.table("../TCGA_BRCA_VSTnorm_count_expr_clinical_data.txt", sep="\t",
...
write.table(merge.chemo.label.data,
            file="../counts_data/counts_data_with_label/TCGA_BRCA_VSTnrom_count_expr_clinical_data.txt",
            sep="\t",
            quote=FALSE,
            row.names=T,
            col.names=NA)
